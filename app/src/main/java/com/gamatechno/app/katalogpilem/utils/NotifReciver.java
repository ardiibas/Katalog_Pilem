...
import com.gamatechno.app.katalogpilem.view.MainActivity;

import java.util.Calendar;

public class NotifReciver extends BroadcastReceiver {
    ...
    public void setRepeatingAlarm(Context context, String type, String time, String message) {
        ...
        Intent intent = new Intent(context, NotifReciver.class);
